...
public class Bayes implements Algorithms{
    ...
    //
            ...
            List<String> resultList = Arrays.asList(
                    String.valueOf("japanese +"+calculeProba.get("finalJapaneseProba")),
                    String.valueOf("american +"+calculeProba.get("finalAmericanProba")),
                    String.valueOf("european +"+calculeProba.get("finalEuropeanProba"))
            );
