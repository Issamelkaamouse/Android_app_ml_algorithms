            ...
            public void onClick(View view) {
                ...
                if(checkedRadioButtonText.equals("KNN")){
                    ...
                    try {
                        ...
                        decision = DecisionEvaluator.evaluateDecisionTree(decisionTree, mpgValue, displacementValue, accelerationValue, weightValue, horsePowerValue);
                        System.out.println(decision);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
