...
public class Knn implements Algorithms{
    ...
    public List<String> Knn(List<MachineLearning> machineLearningList, double mpgValue, double displacementValue, double accelerationValue, double weightValue, double horsePowerValue, int kValue) {
        ...
        minOriginValues.add(mostFrequentOrigin);

        return minOriginValues;
    }
